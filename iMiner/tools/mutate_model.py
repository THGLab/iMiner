...
orginal_aa = triplet_to_singlet[mdl1.chains[chain].residues[respos].name]
mutated_aa = triplet_to_singlet[restyp]
...
#set up the mutate residue selection segment
s = Selection(mdl1.chains[chain].residues[respos].atoms['CA'].select_sphere(8))
...
#give a proper name
mdl1.write(file="./mutated_protein_cdd1845/"+modelname+'_'+orginal_aa+respos+mutated_aa+'.pdb')
