...
data = load_data(datapath, 'frag_gselfies.pkl', bs=bs, bptt=70)
...
#learner = load_learner(Path(datapath), 'chembl_frag_pretrained.pkl')
#learner.data = data
...
calls = []
calls.append(callbacks.SaveModelCallback(learner, every='improvement', name="frag_checkpoint"))
...
learner.export(datapath + "dahai_frag_pretrained.pkl")
