...
For input file definitions: https://valdes-tresanco-ms.github.io/gmx_MMPBSA/input_file/#the-input-file 
This file is adapted from: https://github.com/dptech-corp/Uni-GBSA/
'''
from pathlib import Path


PBSA_VERSION = 1.5
PBSA_PARAMETER_FILE = Path(__file__).parent / "mmpbsa.in"
DEFAULT_PARAMS = {
    "modes": "gb",
    "igb": 2,
    "indi": 4.0,
