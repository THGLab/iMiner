...
# SAVIO
#conda run -p /global/home/groups/co_armada2/env/ign python /global/home/groups/co_armada2/env/InteractionGraphNet/codes/score.py --protein ${1} --ligands ${2} --graph_dic_path ${3} --output ${4} --num_process ${5}